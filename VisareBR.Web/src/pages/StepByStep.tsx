      ...
      <section className="mt-10">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="bg-blue-600 rounded-3xl p-12 text-white shadow-2xl shadow-blue-200">
            ...
            <a href="https://wa.me/your-number" className="bg-white text-blue-600 px-10 py-4 rounded-full font-bold text-lg hover:bg-blue-50 transition-all inline-block">
