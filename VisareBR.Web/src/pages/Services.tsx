    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {services.map((service) => (
              <div key={service.id} className="bg-gray-50 rounded-3xl p-8 hover:shadow-xl transition-all border border-transparent hover:border-gray-200 group">
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a href={whatsappUrl} className="bg-black text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-gray-800 transition-all shadow-lg shadow-gray-200">
