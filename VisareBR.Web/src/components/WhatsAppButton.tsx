...
export default function WhatsAppButton() {
  ...
  return (
    <a 
      ...
      className="fixed bottom-6 right-6 z-50 transition-all hover:scale-110 flex items-center justify-center filter drop-shadow-md select-none cursor-pointer"
